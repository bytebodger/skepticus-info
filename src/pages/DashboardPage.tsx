                ...
                <ol>
                    ...
                    <li>Callers
                        <ol>
                            ...
                            <li>Believers (of any stripe) are given priority in the call queue. If you're an atheist/agnostic/non, you're welcoem to call in.  But please understand that the conversation is generally more engaging with a distinct difference of opinions.  So please understand if you are skipped over, of if your call is cut short, so we can get to believers who are waiting in the queue.</li>
