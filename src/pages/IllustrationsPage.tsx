...
export function IllustrationsPage() {
  ...
  return (
    <section aria-labelledby="illustrations-heading">
      ...
      <ul className="illustration-list" aria-label="Available illustrations">
      ...
      {selected ? (
        <div className="illustration-overlay" role="dialog" aria-modal="true" aria-label={selected.name}>
          <button
            type="button"
          ...
          <div className="illustration-stage">
            <img className="illustration-image" src={selected.path} alt={selected.alt} />
          </div>
        </div>
      ) : null}
    </section>
