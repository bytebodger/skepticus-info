        ...
        <section aria-labelledby='syllogism-builder-heading'>
            ...
            <div className='syllogism-grid'>
                <article className='card'>
                    <h3>Premises</h3>
                    <form onSubmit={handleAddPremise}
                        className='syllogism-form'
                        aria-label='Add premise form'>
                        <label htmlFor='premise-input'
                            className='sr-only'>
                            Add premise
                        </label>
                        <input
                        ...
                        />
                        <button type='submit'
                            className='syllogism-button'>
                            Add Premise
                        </button>
                    </form>

                    <ol className='syllogism-list'
                        aria-label='Premises list'>
                        {premises.map((premise, index) => (
                            <li key={premise.id}
                                className='syllogism-item'>
                                <div>
                    ...
                    {premises.length === 0 ?
                        <p className='muted'>No premises yet.</p> : null}
                </article>

                <article className='card'>
                    <h3>Conclusion</h3>
                    <form onSubmit={handleSetConclusion}
                        className='syllogism-form'
                        aria-label='Set conclusion form'>
                        <label htmlFor='conclusion-input'
                            className='sr-only'>
                            Set conclusion
                        </label>
                        <input
