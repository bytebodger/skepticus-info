...
export function SyllogismsPage() {
  ...
  return (
    <section aria-labelledby="syllogisms-heading">
      ...
      {selected ? (
        <article className="card syllogism-view" aria-labelledby="open-syllogism-title">
          <h3 id="open-syllogism-title">{selected.title}</h3>

          <section aria-labelledby="premises-heading" className="section-gap">
            <h4 id="premises-heading" className="syllogism-subheading">
              Premises
            </h4>
        ...
        <ul className="syllogism-title-list" aria-label="Syllogism titles">
